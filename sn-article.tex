...
\title[aaa]{A machine-learning-based graphical tool for interactive labeling of plankton image datasets}
%\title[aaa]{Quick interactive labeling of plankton image datasets with a machine-learning-based graphical tool}
...
\keywords{Machine learning, Visual interactive labeling, Dataset annotation}
